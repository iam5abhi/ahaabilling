    ...
    <div className="row">
      ...
      <div className="col-md-6">
        <div className="form-group">
          ...
          <input type="url" className="form-control" id="KOT" placeholder="Kot Detail" name="kotdetails" defaultValue={userdata.kotdetails} onChange={(event)=>{ dataHandler(event)}}  />
        </div>
      </div>
    </div>
    <br />
    ...
    <div className="row">
      <div className="col-md-4">
        <div className="form-group">
          ...
          <input type="text" className="form-control" placeholder="Enter Amount" id="Amount" name="TotalAmount"  value={userdata.totalBillAmount} disabled />
        </div>
      </div>
      <div className="col-md-4">
        <div className="form-group">
